...
class Account:
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(self.transaction_id, original_balance, self.balance))
...
class Email:
    ...
    def __init__(self, msg, sender, recipient_name):
        self.msg = msg
        self.sender = sender
        self.recipient_name = sender.server.clients[recipient_name]
...
class Server:
    ...
    def send(self, email):
        ...
        email.recipient_name.inbox.append(email)
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        if change_list is None:
            ...
            def remove_coins(coins, change_list):
                if len(change_list) == 1:
                    return remove_one(coins, change_list[0])
                else:
                    rest = remove_one(coins, change_list[0])
                    return remove_coins(rest, change_list[1:])
            self.coins = remove_coins(self.coins, change_list)
