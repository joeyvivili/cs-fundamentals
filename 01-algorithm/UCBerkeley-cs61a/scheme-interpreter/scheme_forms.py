...
def make_let_frame(bindings, env):
    ...
    # BEGIN PROBLEM 14
    formals, vals = nil, nil    # make a formal list && a vals list (corresponding to formal list)
    symbols = []
    while bindings is not nil:
        ...
        validate_formals(formals)  # validate that every element is a symbol && no duplicate
